...
validation_ref: p2r5_continuation_branch_readback_and_main_readback_after_merge
...
| `Validation/sync_report.md` | этот отчёт фиксирует продолженную ветку, изменённые зоны, перечитывание и отсутствие блокеров |
