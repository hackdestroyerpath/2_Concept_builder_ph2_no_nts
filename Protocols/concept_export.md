...
Протокол описывает подготовку export-результата для выбранной концепции. Export — это проверяемый production-вывод, а не случайная подборка страниц, которую кто-то героически назвал финалом.
