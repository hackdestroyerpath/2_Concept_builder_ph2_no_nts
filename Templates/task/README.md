...
Машинный маршрут сохранён как точная последовательность протоколов: жизненный цикл задачи, вопросы/ответы, требования, исполнение и проверка.

## Контракт навигации

| Объект | Проверка |
|---|---|
| шаблон `README.md` | содержит маршруты ко всем дочерним артефактам |
| `page_registry.jsonl` | содержит владельца, источник и обратные ссылки для всей цепочки артефактов |
| дочерний артефакт | имеет обратную ссылку через родительский `README.md` и ссылку на протокол, если применимо |
