...
| Активный rework-сегмент | `P2R3` — закрытие language-gate contradiction и подготовка final acceptance candidate archive вне repo |
| Последний checkpoint merge | PR `#6`, merge commit `276b893043cd6f21f1ecf0cd18afc9faa6c5d52d`, область до `P2R-001` / `P2-006` |
| P2R3 merge | PR `#7`, merge commit `a464714180f05df955579c56cc34088d56aadfe2`, затем final polish на `main` |
| Основание | утверждённый Phase 1 defect register `D-001`…`D-063` и third rejection language handoff |
...
| Статус финального принятия | `passed`: `D-001`…`D-063` имеют closure evidence, blockers `0`, `remaining: []` |
| Следующий безопасный шаг | вернуть локальный final acceptance candidate archive; archive и handoff materials не добавляются в repo |
...
| [`Protocols/`](Protocols/protocol_index.md) | Исполнимые протоколы, routing matrix и failure routes. | `Service Mode` | [`Protocols/protocol_index.md`](Protocols/protocol_index.md) | [`Protocols/protocol_index.md`](Protocols/protocol_index.md) |
...
| [`Validation/`](Validation/final_check.md) | Evidence-проверки, пробный прогон, language/navigation check и sync report. | `Service Mode` | [`Validation/final_check.md`](Validation/final_check.md), [`Validation/sync_report.md`](Validation/sync_report.md) | [`Validation/final_check.md`](Validation/final_check.md), [`Validation/sync_report.md`](Validation/sync_report.md) |
